...
public class GlobalExceptions extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(value = BookDetailsNotProvidedException.class)
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	public final ErrorDetails handleBookDetailsNotProvidedException(BookDetailsNotProvidedException ex, WebRequest request)
			throws Exception {
	...
	@ExceptionHandler(value = BookNameEmptyException.class)
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	public final ErrorDetails handleBookNameEmptyException(BookNameEmptyException ex, WebRequest request)
			throws Exception {
